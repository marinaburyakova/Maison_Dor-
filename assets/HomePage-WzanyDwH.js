import{j as e}from"./index-CRGPpb4M.js";import{r as o,L as f}from"./vendor-vYKS_erO.js";import{p as b}from"./product3-DEWBbiUP.js";const y=""+new URL("product29.BOALRsQ4.jpg",import.meta.url).href,v=""+new URL("product2.32vY8PuK.jpg",import.meta.url).href,w=""+new URL("product0.B2VGaqqH.jpg",import.meta.url).href,j=""+new URL("luxury-fashion.DkVMH80p.mp4",import.meta.url).href,S=""+new URL("luxury-fashion.DoPpK4rz.webm",import.meta.url).href,I=()=>{const i=o.useRef(null),[s,c]=o.useState(!1),[g,l]=o.useState(!1),[n,d]=o.useState(""),[u,p]=o.useState(!1),a=o.useRef(null);o.useEffect(()=>{const r=document.createElement("style");return r.textContent=`
      @keyframes fadeInUp {
        from {
          opacity: 0;
